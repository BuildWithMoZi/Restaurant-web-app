export const site = {
  name: "Lucious – Restaurant & Cuisine",
  shortName: "Lucious",
  description:
    "A premium dining experience with global cuisine, signature dishes, and chef-crafted specials.",
  locationLine: "Lucious • Global Cuisine",
  tagline: "Royal Mediterranean dining, crafted to perfection.",
  about: {
    eyebrow: "Our Story",
    title: "A sanctuary of Mediterranean soul & global craft.",
    description:
      "Born from the sun-bleached shores of Lucious, our restaurant blends coastal warmth with refined international technique — every plate a celebration of land, sea, and heritage.",
    paragraphs: [
      "At Lucious, we believe dining is theatre — candlelit terraces, the scent of olive wood, and plates that arrive like works of art. Our kitchen honours timeless Aegean recipes while embracing flavours from across the globe.",
  ...
  hero: {
    ...
    subheadline:
      "An intimate coastal dining experience with chef-crafted mezze, flame-kissed seafood, and signature plates inspired by Lucious sunsets.",
    ...
    images: [
      {
        ...
        alt: "Candlelit terrace dining with coastal views at Lucious",
        label: "Sunset Terrace",
        span: "large" as const,
      },
      {
        src: "/hero/seafood-v1.png",
        alt: "Lucious Global Cuisine restaurant entrance with tropical greenery",
        label: "Fresh Catch",
        span: "small" as const,
      },
      {
        src: "/hero/mezze-v1.png",
        alt: "Lucious food menu with Mediterranean mezze and shared plates",
        label: "Mezze Ritual",
        span: "small" as const,
      },
      {
  ...
  email: "reservations@lucious-cuisine.com",
  hours: {
